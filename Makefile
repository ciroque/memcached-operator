...
# ciroque.solutions/memcached-operator-bundle:$VERSION and ciroque.solutions/memcached-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= ciroque.solutions/memcached-operator
